<template>
    <li>
        <a v-if="data" href="javascript:" :style="`background-color: #${data.badge_color}`">
            ...
            <!-- <div unelevated label="Back" type="reset" class="q-mt-sm full-width" value="hello" name="hello" @click="copyLink(data.referral_code)">COPY ID</div> -->
        </a>
